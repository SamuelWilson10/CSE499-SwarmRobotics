...
#define MotorDriverLeft(pwm , dir) { switch (dir) { case -1: analogWrite(motorL1, 255 - pwm); digitalWrite(motorR1,HIGH); break; case 1: analogWrite(motorL1,  pwm); digitalWrite(motorR1,LOW); break;}}
#define MotorDriverRight(pwm , dir) { switch (dir) { case -1: analogWrite(motorL2, 255 - pwm); digitalWrite(motorR2,HIGH); break; case 1: analogWrite(motorL2, pwm); digitalWrite(motorR2,LOW); break; }}
